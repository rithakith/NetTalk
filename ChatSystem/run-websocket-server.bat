...
if not exist out\com\chatapp\server\WebSocketBridgeServer.class (
...
java -cp "out;lib\Java-WebSocket-1.5.3.jar;lib\gson-2.8.9.jar;lib\slf4j-api-1.7.36.jar;lib\slf4j-simple-1.7.36.jar" com.chatapp.server.WebSocketBridgeServer
pause