...
public class Message implements Serializable {
    ...
    public enum MessageType {
        ...
        TYPING_START, TYPING_STOP, MESSAGE_DELIVERED, MESSAGE_SEEN,
        // Admin command types
        ADMIN_KICK, ADMIN_BAN, ADMIN_MUTE, ADMIN_UNMUTE, ADMIN_BROADCAST, ADMIN_STATS,
        // Quiz system types
        QUIZ_CREATED, QUIZ_INVITATION, QUIZ_JOIN, QUIZ_START, QUIZ_QUESTION, QUIZ_ANSWER, 
        QUIZ_RESULTS, QUIZ_ENDED, QUIZ_DELETED
    }
